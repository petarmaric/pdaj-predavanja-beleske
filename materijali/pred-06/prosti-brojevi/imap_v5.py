...
MULTIPROCESSING_GREED_FACTOR = 10
...
def guesstimate_optimal_chunk_size(max_num, concurency):
    ...
    # DECENT: Each child process *should* bite at several matrix rows, depending on how greedy our algo is
    return MULTIPROCESSING_GREED_FACTOR * max_num
